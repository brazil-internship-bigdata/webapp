    ...
    <body>
    	<form method="post" action="signin">
    	  <fieldset>
                ...
                <label for="company_full_name">Company full name <span class="require">*</span></label>
                ...
                <label for="password_confirmation">Password confirmation <span class="require">*</span></label>
                ...
                <label for="responsible_1_name">Responsible 1 name <span class="require">*</span></label>
                ...
                <label for="responsible_1_phone">Responsible 1 phone <span class="require">*</span></label>
                ...
                <label for="responsible_1_email">Responsible 1 email <span class="require">*</span></label>
                ...
                <label for="project_responsible">Project responsible <span class="require">*</span></label>
